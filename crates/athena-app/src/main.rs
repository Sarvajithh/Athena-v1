...
fn main() {
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::onboarding::extract_syllabus_text,
            commands::onboarding::count_course_linked_deadlines,
            commands::onboarding::delete_course,
            commands::onboarding::update_course_notes,
            commands::onboarding::link_course_to_classroom,
            commands::onboarding::add_course_log,
            commands::onboarding::list_course_logs,
            commands::onboarding::delete_course_log,
            ...
            commands::integrations::start_google_calendar_oauth,
            commands::integrations::disconnect_google_calendar,
            commands::integrations::list_calendar_events,
            ...
            commands::integrations::list_classroom_materials,
            commands::integrations::pull_classroom_materials,
            commands::integrations::mark_classroom_materials_seen,
            commands::integrations::set_classroom_material_studied,
            ...
            commands::integrations::extract_deadlines_from_calendar,
            commands::integrations::list_google_calendars,
            commands::integrations::get_google_calendar_ids,
            commands::integrations::set_google_calendar_ids,
            ...
            commands::ai::parse_chat_deadline_draft,
