...
/// registered ahead of time — unlike Gmail/Google Classroom (which
/// allow `http://127.0.0.1:*` wildcard loopback redirects), Notion
/// needs one exact, stable URI. `47123` is arbitrary but fixed, chosen
/// in the ephemeral-port range and unlikely to collide with a common
/// dev-server default (3000/5173/8080/etc.); register
/// `http://127.0.0.1:47123/callback` as the redirect URI in the
